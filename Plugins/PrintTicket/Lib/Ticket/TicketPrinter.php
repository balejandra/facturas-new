...
class TicketPrinter
{
    public const KV_ALIGN_LEFT = STR_PAD_RIGHT;
    public const KV_ALIGN_RIGHT = STR_PAD_LEFT;
    public const KV_ALIGN_CENTER = STR_PAD_BOTH;
    ...
    public function __construct(int $width)
    {
        ...
        //$this->connector = new NetworkPrintConnector("192.168.194.210", 9100);
    ...
    public function textKeyValue(
        ?string $key,
        ?string $value,
        string  $keyAlign = self::KV_ALIGN_LEFT,
        string  $valueAlign = self::KV_ALIGN_RIGHT
    ) {
