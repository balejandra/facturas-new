...
const cartElements = {
	...
	docClientLabel: getElement("docClient"),
	nameClientLabel: getElement("nameClient"),
};
...
class Cart {
	...
	docClientLabel = () => cartElements["docClientLabel"];
	nameClientLabel = () => cartElements["nameClientLabel"];
	...
	updateView = (data = {}) => {
		console.log(data);
		cart().docClientLabel().textContent = data.doc.cifnif;
		cart().nameClientLabel().textContent = data.doc.nombrecliente;
...
class Checkout {
	...
	changeAmountExchangeLabel = () =>
		checkoutElements["changeAmountExchangeLabel"];
	tenderedAmountExchangeLabel = () =>
		checkoutElements["tenderedAmountExchangeLabel"];
